...
# auto_login_user и auto_start_lesson извлечены в login_service.py (задача 4.1,
# шаг 12d) — реэкспортируются выше.
...
# perform_login извлечён в login_service.py (задача 4.1, шаг 12d) —
# реэкспортируется выше.
